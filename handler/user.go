...
func (h *userHandler) Login(c *gin.Context) {
	// tangkap input dari user
	// map input dari user ke struct LoginInput
	// struct diatas kita passing sebagai parameter service
	...
	// cek apakah ada error dari service
...
func (h *userHandler) CheckEmailAvailability(c *gin.Context) {
	// tangkap input dari user
	// map input dari user ke struct CheckEmailInput
	// struct diatas kita passing sebagai parameter service
...
func (h *userHandler) UploadAvatar(c *gin.Context) {
	// tangkap input dari user
	// save gambar ke folder "images/"
	// service akan memanggil repository untuk mengupdate data user yang bersangkutan
